	...
	return (
		<Card ref={cardRef} className="max-w-sm border-0">
			<CardHeader className="flex flex-row justify-between">
				<CardTitle className="text-md text-shadow font-extrabold">
					{title}
				</CardTitle>
			...
			<CardFooter>
				<div className="w-full grid space-y-2">
					...
					<BounceButton className="inline-flex text-md font-extrabold text-shadow gap-2 px-2">
						Detailed View{" "}
						<ArrowRight
							strokeWidth={3}
							className="h-4 w-4 text-md font-extrabold"
						/>
					</BounceButton>
					<BounceButton
						variant={"outline"}
						className="inline-flex text-md font-extrabold text-shadow gap-2 px-2"
					>
